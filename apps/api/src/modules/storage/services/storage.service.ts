...
export class StorageService implements OnModuleInit {
  ...
  async copyObject(params: CopyObjectParams): Promise<void> {
    try {
      ...
      this.logger.error(
        `Error copying object from ${params.sourceBucket}/${params.sourceObject}`,
        error,
      );
      throw error;
    }
  ...
  async getPresignedUrl(params: SignedUrlParams): Promise<string> {
    try {
      ...
      this.logger.error(
        `Error generating presigned URL for: ${params.bucket}/${params.objectName}`,
        error,
      );
      throw error;
    }
  ...
  async getPresignedPutUrl(params: SignedUrlParams): Promise<string> {
    try {
      ...
      this.logger.error(
        `Error generating presigned PUT URL for: ${params.bucket}/${params.objectName}`,
        error,
      );
      throw error;
    }
